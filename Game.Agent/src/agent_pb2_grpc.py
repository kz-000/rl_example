...
def add_AgentServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'api.agent.AgentService', rpc_method_handlers)
...
class AgentService(object):
    ...
    def Step(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.agent.AgentService/Step',
    ...
    def Reset(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.agent.AgentService/Reset',
